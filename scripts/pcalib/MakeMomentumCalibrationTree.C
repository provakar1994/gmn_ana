/*
  Momentum calibration script.
  -----
  A. Puckett CREATED <puckett@jlab.org> 
*/
...
void MakeMomentumCalibrationTree(const char *configfilename, const char *outputfilename="pcdout/NewMomentumFit.root") {
