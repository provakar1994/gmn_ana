...
int pDE_simu(const char *configfilename) {
  ...
  cdxdy->cd(1);
  TH2F *h_dxdy_earm = (TH2F*)earm_rdf.Histo2D({"h_dxdy_earm","",200,-1.5,1.5,200,-3,2},"dy","dx","weight")->Clone();
  h_dxdy_earm->Draw("colz");
  cdxdy->cd(2);
  TH2F *h_dxdy_eNharm = (TH2F*)eNharm_rdf.Histo2D({"h_dxdy_eNharm","",200,-1.5,1.5,200,-3,2},"dy","dx","weight")->Clone();
